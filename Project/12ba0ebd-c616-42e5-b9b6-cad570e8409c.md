...
By default, the Project Web App Site comes with a 25GB limit and is a separate from the  [limit on all data stored in the SharePoint site collection](http://technet.microsoft.com/library/8f34ff47-b749-408b-abc0-b605e1f6d498%28Office.14%29.aspx#__toc204662450) where Project Web App is enabled.
 ...
 **Note:** For large customers, quota can be increased. Please contact Microsoft.

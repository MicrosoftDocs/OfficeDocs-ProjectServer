...
# What's deprecated or removed in Project Servers 2016 or 2019
Learn what has been deprecated or removed in Project Servers 2016 or 2019.
  
This article describes features and functionality that have been removed in Project Servers 2016 or 2019 that had been previously available in Project Server 2013.
...
The My Tasks and associated Exchange Task Sync features have been removed in SharePoint Servers 2016 or 2019. The Work Management Service Application that is required for both features has also been removed.
  
## Project Server Interface (PSI) Project class removed
<a name="ProjectClass"> </a>

The Project class in the PSI is not supported in Project Servers 2016 or 2019. For all new development, use the [Project Client Side Object Model (CSOM)](http://go.microsoft.com/fwlink/p/?LinkId=798162&amp;clcid=0x409).
...
In Project Servers 2016 or 2019, the following PSI members have been removed: 
...
In Project Servers 2016 or 2019, Project Server Interface (PSI) extension scenarios are not supported. These scenarios enabled integration with custom Windows Communication Foundation (WCF) services. 

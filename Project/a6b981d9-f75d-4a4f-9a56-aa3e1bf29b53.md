...
Reset-SPProjectPCSSettings [-AssignmentCollection <SPAssignmentCollection>] [-ServiceApplication <PsiServiceApplicationPipeBind>]
...
The **Reset-SPProjectPCSSettings** cmdlet lets you reset the settings that control the operations of the Project Calculation Engine on Project Server 2016. The cmdlet requires you to identify the Project Server service application.

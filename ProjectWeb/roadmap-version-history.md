...
|:-----|:-----|:-----|
|0.8.7.40  <br/> |October 2020  <br/> |Plugins added to support Urls updates in ConnectionSettings entity to support SharePoint site rename and Microsoft 365 tenant rename.  <br/>Plugins and roles added to support Roadmap entities being owned by Microsoft 365 groups in the PowerApps Platform. |

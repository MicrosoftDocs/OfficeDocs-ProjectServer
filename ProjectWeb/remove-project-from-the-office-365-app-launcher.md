...
If you have users with one of the [Office 365 User view access to Project and Roadmap](office-365-user-access-to-project-and-roadmap.md#office-365-user-view-access-to-project-and-roadmap), a Project tile will display in the Office 365 App Launcher.  

...
In Dynamics 365, you can create additional [business units](https://docs.microsoft.com/en-us/power-platform/admin/create-edit-business-units) in your Common Data Service (CDS) instance.  If you want Project for the web users in the business unit to be able to access and use it, you need to made sure that the associated team in which your users are members have the **Project User** role applied to it.
...
> [!NOTE]
> You must have Global Admin admin role to do this.
...
7. In the Manage Team Roles screen, select **Project User**, and then click **OK**.<br/>

    ![Select user](media/projectuserrole.png)

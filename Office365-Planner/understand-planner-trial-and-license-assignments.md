...
>![IMPORTANT]
> We are in the midst of rolling Copilot in Planner (preview) out to your organization. After we have fully rolled out, if your organization does not have premium Project licenses, you can start free 30-day trials for your users and assist users who have requested a premium license for the Planner app in Teams.

## 30-day trial of premium features

When users follow the prompts to enable a 30-day trial, they're provided access to all the features and functionality in a license for Project Plan 3. Project Plan 3 includes task history, advanced dependencies, custom calendars, timeline (Gantt) view, sprints, custom fields, team workload, and managing goals. Once the trial starts, users can access these features within the Planner app in Teams, or with Project for the Web (https://project.microsoft.com).
.
